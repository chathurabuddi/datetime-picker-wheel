...
import lk.chathurabuddi.datetimepicker.wheel.widget.WheelHourPicker;
import lk.chathurabuddi.datetimepicker.wheel.widget.WheelMinutePicker;
...
public class SingleDateAndTimePicker extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setIsAmPm(a.getBoolean(R.styleable.SingleDateAndTimePicker_picker_isAmPm, IS_AM_PM));
